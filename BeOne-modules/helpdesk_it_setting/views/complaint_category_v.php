        ...
        <form id="mainForm" class="form-horizontal">
            <div class="panel panel-danger">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title"><i class="fa fa-edit"></i>&nbsp;<strong id="ftitle">Add</strong> Complaint Category</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6 pinggir-kanan">
                            <div class="form-group row">
                                <label for="status_code" class="control-label col-lg-4">Category Code</label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <span class="input-group-addon mandatory"><i class="fa fa-barcode"></i></span> 
                                        <input type="text" autofocus="" id="category_code" name="category_code" placeholder="Category Code..." data-validation="required" class="form-control" pattern="[A-Za-z-0-9]{5}" title="Alpha numeric only 5 character">
                                    </div>
                                </div>
                            </div><!-- /.form-group -->
                            <div class="form-group row">
                                <label for="complaint_status" class="control-label col-lg-4">Complaint Category</label>
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <span class="input-group-addon mandatory"><i class="fa fa-file-o"></i></span> 
                                        <input type="text" autofocus="" id="category" name="category" placeholder="Complaint category..." data-validation="required" class="form-control">
                                    </div>
                                </div>
                            </div><!-- /.form-group -->
                        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">                                
                <h3 class="panel-title"><i class="fa fa-table"></i> Table Complaint Category</h3>
                <ul class="panel-controls">
                    <li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
                </ul>                                
            </div>
