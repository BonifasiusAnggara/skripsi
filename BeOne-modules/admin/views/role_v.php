                ...
                <div class="panel-body">                                                                        
                    <div class="row col-lg-6">
                        <div class="form-group row pinggiran">
                            <label class="control-label col-lg-4" for="usergroup_id"><span class="label label-warning blink-me"><i class="fa fa-warning"></i>Select first</span> &nbsp;User Group</label>
                            <div class="col-lg-8">
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">                                
                <h3 class="panel-title"><i class="fa fa-table"></i> Table Role</h3>
                <ul class="panel-controls">
                    <li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
                </ul>                                
            </div>
                ...
                <div id="mainTable" class="box-body">
                    <div style="padding: 0 20px 10px 20px" class="row">
                        ...
                        <div class="div-btn pull-right">
                            <a id="btnAddRole" title="Add Role" href="#" class="btn btn-primary btn-line"><i class="fa fa-plus"></i>&nbsp;Add Roles</a>
