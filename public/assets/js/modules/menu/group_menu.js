    ...
    var t = $('#mainTable table').DataTable({
        ...
        columns: [
            ...
            {data: 'menu', render: function (data, type, row, meta) {
                    return (row.parent != null) ? '&nbsp&nbsp&nbsp&nbsp<span class="label label-primary">' + data + '</span>' : '<span class="label label-success">' + data + '</span>';
                }},
            {data: 'link'},
            {data: 'parent'},
            {data: 'menuorder'},
...
//--- Select Row , Toggle Row & Delete
    $('#mainTable').selectDTBeOne(t, 'menu/group-menu/delete');
