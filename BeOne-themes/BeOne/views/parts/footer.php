...
<!-- <?php if ($this->router->fetch_class() == 'geolocation'):; ?>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBD7O18DznMvVXrCemri7-zpYR_5YY8bfY"></script>
<?php endif; ?> -->
